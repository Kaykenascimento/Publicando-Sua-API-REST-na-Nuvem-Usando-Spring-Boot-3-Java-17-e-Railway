...
import com.github.wesleyav.desafioapi.services.UsuarioService;
...
public class UsuarioController {
	...
	public ResponseEntity<Page<Usuarios>> findAllPaged(@RequestParam(defaultValue = "0") Integer pageNumber,
			@RequestParam(defaultValue = "10") Integer pageSize) {
		Page<Usuarios> userPage = userService.findAllPaged(pageNumber, pageSize);
	...
	public ResponseEntity<Usuarios> save(@RequestBody Usuarios obj) {
		Usuarios createdUser = userService.create(obj);
	...
	public ResponseEntity<Usuarios> update(@PathVariable Long id, @RequestBody Usuarios user) {
		Usuarios updatedUser = userService.update(id, user);
